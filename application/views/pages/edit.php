	...
	<fieldset>
		...
		<section id="formbuatlaporan">
			<div class="container">
				...
				<form name="createForm" onsubmit="return validasi()"
					action="<?= base_url('control/ubah/' . $laporan->id); ?>" method="POST"
					enctype="multipart/form-data">

					<textarea name="laporan" id="laporan" cols="77" rows="20"
						placeholder="Laporan/Komentar"><?php echo set_value('laporan', $laporan->laporan) ?></textarea>
					<br><br>
