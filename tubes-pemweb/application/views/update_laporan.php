...
<head>
    ...
    <link href="../../public/css/styleUpdate.css" rel="stylesheet">
...
<body>
    <div class="container">
        ...
        <div class="body">  
            <br>
            <h1>Ubah Laporan Anda</h1>
            <hr><br>
            <?php foreach ($posts as $post) : ?>
            <form action='<?php echo base_url('Welcome/update_process/'. $post->id ); ?>' method='post' onSubmit="validasi()">
                <label for="judul"><p>Judul Laporan</p></label><br>
                <textarea name="judul" id="judul" cols="150" placeholder="Ketik Judul Laporan Anda"><?php echo $post->judul ?></textarea>
                ...
                <br><br>
                <button class="updateLapor" type="submit" name="submit" value="Update Lapor!">Update Lapor!</button>
                <br><br>    
                <br>
            </form>
            <?php endforeach; ?>
